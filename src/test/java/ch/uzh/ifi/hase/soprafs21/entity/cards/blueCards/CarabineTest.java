...
public class CarabineTest {
    ...
    private Carabine carabine = new Carabine(Rank.ACE, Suit.SPADES);
    ...
    public void testRange() {
        ...
        carabine.use(player, player, null);
        assertEquals(player.getBaseRange() + 3, player.getRange());
    }
